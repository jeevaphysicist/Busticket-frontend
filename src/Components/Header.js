...
console.log("screen width : ",window.innerWidth);
    ...
    useEffect(()=>{
     ...
     const loginhandler = ()=>{
        ...
        console.log("req :",req);
        fetch(`https://bus-tickets-booking1.herokuapp.com/userdata/login`,{method:"POST",
    ...
    const signuphandler = ()=>{
     ...
     fetch("https://bus-tickets-booking1.herokuapp.com/userdata/signup",{method:"POST",
                                           headers:{"Content-Type":"application/json"},
                                           body:JSON.stringify(req)
                                          }).then(res=>res.json())
                                          .then(result=>{
    ...
    const responseFacebooksignup = (response) => {
     ...
     //socialmedia signup handler
          const socialmediasignuphandler = (userdata)=>{        
            fetch('https://bus-tickets-booking1.herokuapp.com/userdata/socialSignUp',{
              method:"POST",
              headers:{"Content-Type":"application/json"},
          ...
          const socialmedialoginhandler =(userdata)=>{
            fetch('https://bus-tickets-booking1.herokuapp.com/userdata/socialLogin',{
              method:"POST",
              headers:{"Content-Type":"application/json"},
              body:JSON.stringify(userdata)
             }).then(res=>res.json())
            ...
            <div className='row mx-auto'>
              ...
              <center>
                ...
                <div className='col-12 col-sm-12 col-md-1 col-lg-1 col-xl-1 my-3  '>
                   {isloggedIn && (local !== undefined && local.length >0)?<button className='signup ' onClick={()=>logouthandler()}>Logout</button>:<button className="signup " onClick={()=>{setCreateaccountmodal(true)}} >SignUp</button>}
                </div>
      ...
      <Modal  isOpen={loginmodal}
       ...
       >
            ...
            <form className='form'>
               ...
               <div>OR</div>
               <div>          
                  <GoogleOAuthProvider clientId="356946187029-33teigfr6nqas1aamdimflf0nh2935ui.apps.googleusercontent.com">
                       <GoogleLogin
