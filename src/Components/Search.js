       ...
       useEffect(()=>{
        if( userlogindata != undefined && userlogindata.length > 0){
          if(userlogindata[0].password != undefined){
            ...
            console.log("req : ",req);
            fetch("https://bus-tickets-booking1.herokuapp.com/tickets/app/gettickets",{method:"POST",
            ...
            console.log("req : ",req);
            fetch("https://bus-tickets-booking1.herokuapp.com/tickets/social/gettickets",{method:"POST",
            headers:{"Content-Type":"application/json"},
            body:JSON.stringify(req)
            }).then(res=>res.json())
            .then(result=>{
                ...
                <div className='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 text-center'>
                 <div style={{color:"whitesmoke"}} className="my-3 "> Search your bus</div>
                   <div className="card shadow-lg p-4 ">
                    <div style={{color:"ButtonHighlight"}}>Fill the below feilds</div>
