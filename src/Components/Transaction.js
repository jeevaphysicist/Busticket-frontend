...
export default function Transaction() {
  ...
  useEffect(()=>{
    ...
    console.log("cost :",cost);
       ...
       fetch(`https://bus-tickets-booking1.herokuapp.com/busdetails`,{method:"POST",
...
console.log('oldreservedseats',oldreservedseats);
  ...
  const openrazerpay = async()=>{
    ...
    try{
       let orderData;
       orderData = await fetch(`https://bus-tickets-booking1.herokuapp.com/payment`,{method:'POST',
       headers :{'Content-Type' : 'application/json'},
    ...
    const options={
                  ...
                  handler:function(response){
                    ...
                    fetch("https://bus-tickets-booking1.herokuapp.com/payment/savetransaction",{method:'POST',
                                                                  headers:{"Content-Type":"application/json"},
                                                                   body:JSON.stringify({
                                                                 ...
                                                                 if(data != undefined){
                                                                  ...
                                                                  fetch("https://bus-tickets-booking1.herokuapp.com/seatupdate",{method:"PUT",
                                                                  headers:{"Content-Type":"application/json"},
                                                                  ...
                                                                  .then(result=>{
                                                                    ...
                                                                    if(userlogindata != undefined){
                                                                     ...
                                                                     fetch("https://bus-tickets-booking1.herokuapp.com/tickets/appuserticket",{method:"POST",
                                                                      headers:{"Content-Type":"application/json"},                                                                   
                                                                      body:JSON.stringify(req)
                                                                     }).then(response=>response.json())
                                                                     .then(result=>{
                                                                      console.log("ticket data :",result)
                                                                        ...
                                                                        fetch("https://bus-tickets-booking1.herokuapp.com/tickets/socialticket",{
                                                                      method:"POST",
                                                                      headers:{"Content-Type":"application/json"},
                                                                      body:JSON.stringify(req)
                                                                     }).then(response=>response.json())
